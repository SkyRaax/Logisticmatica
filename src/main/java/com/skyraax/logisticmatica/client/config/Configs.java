...
public class Configs implements IConfigHandler {
	...
	public static class Hud {
		...
		public static final ConfigBoolean    CONTAINER_VISUALS_ENABLED = new ConfigBoolean("hudContainerVisualsEnabled", true).apply(HUD_KEY);
		...
		public static final ConfigOptionList LABEL_LAYOUT          = new ConfigOptionList("hudContainerLabelLayout", ContainerLabelLayout.VERTICAL).apply(HUD_KEY);
		public static final ConfigInteger    LABEL_MAX_ITEMS       = new ConfigInteger("hudContainerLabelMaxItems", 12, 1, 64).apply(HUD_KEY);
	...
	public static class Hotkeys {
		...
		public static final ConfigHotkey OPEN_SUBSTITUTIONS     = new ConfigHotkey("openSubstitutions", "").apply(HOTKEYS_KEY);
		public static final ConfigHotkey CYCLE_HUD_PAGE         = new ConfigHotkey("cycleHudPage", "").apply(HOTKEYS_KEY);
